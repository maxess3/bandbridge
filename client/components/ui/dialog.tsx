...
>(
  (
    { className, children, showOverlay = true, onOpenAutoFocus, ...props },
    ref
  ) => {
    ...
    const handleOpenAutoFocus = (e: Event) => {
      // Si onOpenAutoFocus est fourni par le parent, l'utiliser
      if (onOpenAutoFocus) {
        onOpenAutoFocus(e);
        return;
      }

      // Sinon, empêcher le focus automatique de Radix UI et focus le dummy button
      e.preventDefault();
