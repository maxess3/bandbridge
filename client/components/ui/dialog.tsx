...
>(({ className, children, showOverlay = true, ...props }, ref) => {
  ...
  // Gérer la fermeture via le bouton X
  ...
  const renderContent = () => (
    ...
    >
      ...
      <DialogPrimitive.Close
        ...
        className="absolute flex justify-center items-center w-11 h-11 top-2 right-4 hover:bg-accent-foreground rounded-full focus:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground"
      >
