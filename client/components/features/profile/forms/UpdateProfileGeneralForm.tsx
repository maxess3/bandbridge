    ...
    <div className="space-y-6">
      ...
      <div className="space-y-1">
        ...
        <div>
          {fields.map((field, index) => (
            ...
            >
              ...
              <div className="flex-1 space-y-3">
                ...
                <div className="space-y-1">
                  <Label className="opacity-80">Années d'expérience*</Label>
                  <Controller
                    name={`instruments.${index}.experienceYears`}
                    control={control}
                    render={({ field }) => (
                      <Input
                        {...field}
                        ...
                        max="100"
                        className={`w-24 ${
                          errors.instruments?.[index]?.experienceYears &&
                          "border-red-500"
                        }`}
                        onChange={(e) =>
                  ...
                  {errors.instruments?.[index]?.experienceYears && (
                    <p className="text-red-500 text-sm">
                      {errors.instruments[
                        index
                      ]?.experienceYears?.message?.toString()}
                    </p>
                  )}
                </div>
              </div>
          ...
          {errors.instruments && (
            <p className="text-red-500 text-sm">
              {errors.instruments?.message?.toString()}
            </p>
          )}
        </div>
      </div>
